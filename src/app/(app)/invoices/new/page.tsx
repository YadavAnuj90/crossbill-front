...
export default function NewInvoicePage() {
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <PageHeader eyebrow="New export invoice" title="Create invoice" subtitle="Compliance fields fill themselves — focus on the work and the amount." icon={<FileText className="h-5 w-5" />} action={<Button type="submit" loading={saving}><FileText className="h-4 w-4" /> Create invoice</Button>} />
